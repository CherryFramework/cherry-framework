	...
	class UI_Select extends UI_Element implements I_UI {
		...
		public function render() {
			...
			$html .= '<div class="cherry-ui-container ' . esc_attr( $class ) . '">';
				...
				$html .= '<select id="' . esc_attr( $this->settings['id'] ) . '" class="cherry-ui-select" name="' . esc_attr( $name ) . '" size="' . esc_attr( $this->settings['size'] ) . '" ' . $multi_state . ' ' . $filter_state . ' data-placeholder="' . esc_attr( $this->settings['placeholder'] ) . '" ' . $inline_style . ' ' . $input_lock . '>';
